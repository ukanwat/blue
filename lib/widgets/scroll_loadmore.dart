...
//       widget.delegate ?? ScrollLoadMore.buildDelegate();
...
//       return _buildListView(child as ScrollablePositionedList) ?? Container();
//     }
...
//   Widget _buildListView(ScrollablePositionedList listView) {
//     ListView d;
//     d.
//     var delegate = listView.de;
//     outer:
...
//           textBuilder: widget.textBuilder ?? ScrollLoadMore.buildTextBuilder(),
//         ),
