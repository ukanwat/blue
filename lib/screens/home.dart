...
final followedTopicsRef =
    FirebaseFirestore.instance.collection('followed-topics');
...
final accountReportsRef =
    FirebaseFirestore.instance.collection('account-reports');
final userReportsRef = FirebaseFirestore.instance.collection('user-reports');
final commentReportsRef =
    FirebaseFirestore.instance.collection('comment-reports');
