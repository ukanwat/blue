 ...
 */
export declare type JoinTable<L extends TableModel, R extends TableModel, KeyExcludeOptional extends keyof L | keyof R | void = void> = Omit<OverwriteNeverToUnknown<L & R>, KeyExcludeOptional extends void ? never : KeyExcludeOptional>;
/**
...
declare type TypeFromJointTable<T extends TableAliasModel> = FormatIntersect<OverwriteNeverToUnknown<UnionToIntersection<FlateJointTable<T>>>>;
/**
 * @returns ```ts
 * {
...
export declare type FlateJointTable<T extends TableAliasModel> = T extends {
    [fld: string]: infer F;
