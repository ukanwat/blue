...
export declare type Reverse<Tuple extends any[]> = Reverse_<Tuple, []>;
declare type Reverse_<Tuple extends any[], Result extends any[]> = {
    1: Result;
...
declare type Concat_<Tuple1 extends any[], Tuple2 extends any[]> = {
    1: Reverse<Tuple1>;
