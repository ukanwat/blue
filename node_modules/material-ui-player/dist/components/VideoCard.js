...
var VideoCard = function (props) {
    ...
    var _a = hooks_1.useMedia(getInitialState(props), props.fadeSettings), state = _a.state, pause = _a.pause, setSize = _a.setSize, load = _a.load, play = _a.play, stop = _a.stop, setCurrentTime = _a.setCurrentTime, setProgress = _a.setProgress;
    ...
    var classes = useStyles({ width: state.width, height: state.height, background: props.background });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    player.current.onloadedmetadata = function () { return setSize(player.current); };
                    _a.label = 2;
    ...
    return (react_1.default.createElement(core_1.Card, { className: classes.card },
        react_1.default.createElement(core_1.CardContent, { className: classes.cardContent },
            react_1.default.createElement("div", { className: classes.videoContainer },
                react_1.default.createElement("video", { style: { opacity: state.fade }, ref: player, key: state.key, className: classes.video }, state.url && react_1.default.createElement("source", { type: utils_1.getMimeType(state.url), src: state.url })))),
        react_1.default.createElement(core_1.CardActions, { className: classes.actions },
            react_1.default.createElement(core_1.Grid, { container: true, justifyContent: "center", alignItems: "center" },
                ...
                react_1.default.createElement(core_1.Grid, { item: true, xs: props.speed ? 6 : 12, sm: props.speed ? 3 : 6 },
                    react_1.default.createElement(index_1.VolumeBar, { player: player.current, color: props.color, thickness: props.thickness, MuteProps: props.MuteProps }))))));
};
